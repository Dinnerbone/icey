...
describe('Channel', () => {
    describe('#addEvent(event)', () => {
        it('applies event', () => {
            ...
            const event = new Events.Base('2001-01-01 00:00:00', 'test');
        ...
        it('records event', () => {
            const channel = new Channel();
            const event1 = new Events.Base('2001-01-01 00:00:00', 'test');
            const event2 = new Events.Base('2001-01-01 00:00:01', 'test');
