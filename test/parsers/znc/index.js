...
describe('Parsing a line', () => {
    ...
    describe('Parsing a message', () => {
        it('Ordinary message', () => {
            ...
            expect(on.message).to.have.been.calledOnce.calledWithExactly(moment('2001-01-01T01:23:45Z'), 'Dinnerbone', 'Hello world! :)');
        });

        it('Empty message', () => {
            parser.parseLine('2001-01-01', '[01:23:45] <Dinnerbone>  ');
            expect(on.message).to.have.been.calledOnce.calledWithExactly(moment('2001-01-01T01:23:45Z'), 'Dinnerbone', ' ');
        });
    });
    ...
    describe('Parsing an action', () => {
        it('Ordinary action', () => {
            ...
            expect(on.action).to.have.been.calledOnce.calledWithExactly(moment('2001-01-01T01:23:45Z'), 'Dinnerbone', 'does an action');
        });

        it('Empty action', () => {
            parser.parseLine('2001-01-01', '[01:23:45] * Dinnerbone ');
            expect(on.action).to.have.been.calledOnce.calledWithExactly(moment('2001-01-01T01:23:45Z'), 'Dinnerbone', '');
        });
    });

    it('Parsing a join', () => {
        parser.parseLine('2001-01-01', '[01:23:45] *** Joins: Dinnerbone (dinnerbone@dinnerbone.com)');
        expect(on.join).to.have.been.calledOnce.calledWithExactly(moment('2001-01-01T01:23:45Z'), 'Dinnerbone');
    });

    describe('Parsing a kick', () => {
        it('Ordinary kick', () => {
            parser.parseLine('2001-01-01', '[01:23:45] *** Troll was kicked by Dinnerbone (You suck!)');
            expect(on.kick).to.have.been.calledOnce.calledWithExactly(moment('2001-01-01T01:23:45Z'), 'Dinnerbone', 'Troll', 'You suck!');
        });

        it('Empty message', () => {
            parser.parseLine('2001-01-01', '[01:23:45] *** Troll was kicked by Dinnerbone ( )');
            expect(on.kick).to.have.been.calledOnce.calledWithExactly(moment('2001-01-01T01:23:45Z'), 'Dinnerbone', 'Troll', ' ');
        });
    });
    ...
    describe('Parsing a mode change', () => {
        it('Adding a single mode', () => {
            ...
            expect(on.mode).to.have.been.calledOnce.calledWithExactly(moment('2001-01-01T01:23:45Z'), 'Dinnerbone', '+m');
        });
        ...
        it('Adding a single mode with parameter', () => {
            ...
            expect(on.mode).to.have.been.calledOnce.calledWithExactly(moment('2001-01-01T01:23:45Z'), 'Dinnerbone', '+v voice');
        });
        ...
        it('Adding and removing multiple modes with parameters', () => {
            ...
            expect(on.mode).to.have.been.calledOnce.calledWithExactly(moment('2001-01-01T01:23:45Z'), 'Dinnerbone', '+vm-oS+k voice op key');
        });
    });

    it('Parsing a name change', () => {
        parser.parseLine('2001-01-01', '[01:23:45] *** Dinnerbone is now known as Djinnibone');
        expect(on.nick).to.have.been.calledOnce.calledWithExactly(moment('2001-01-01T01:23:45Z'), 'Dinnerbone', 'Djinnibone');
    });

    describe('Parsing a notice', () => {
        it('Ordinary notice', () => {
            parser.parseLine('2001-01-01', '[01:23:45] -Dinnerbone- Hey, listen!');
            expect(on.notice).to.have.been.calledOnce.calledWithExactly(moment('2001-01-01T01:23:45Z'), 'Dinnerbone', 'Hey, listen!');
        });

        it('Empty notice', () => {
            parser.parseLine('2001-01-01', '[01:23:45] -Dinnerbone-  ');
            expect(on.notice).to.have.been.calledOnce.calledWithExactly(moment('2001-01-01T01:23:45Z'), 'Dinnerbone', ' ');
        });
    });
    ...
    describe('Parsing a part', () => {
        it('Ordinary part', () => {
            ...
            expect(on.part).to.have.been.calledOnce.calledWithExactly(moment('2001-01-01T01:23:45Z'), 'Dinnerbone', 'Goodbye, cruel channel!');
        });

        it('Empty message', () => {
            parser.parseLine('2001-01-01', '[01:23:45] *** Parts: Dinnerbone (dinnerbone@dinnerbone.com) ()');
            expect(on.part).to.have.been.calledOnce.calledWithExactly(moment('2001-01-01T01:23:45Z'), 'Dinnerbone', '');
        });
    });
    ...
    describe('Parsing a quit', () => {
        it('Ordinary part', () => {
            ...
            expect(on.quit).to.have.been.calledOnce.calledWithExactly(moment('2001-01-01T01:23:45Z'), 'Dinnerbone', 'Goodbye, cruel network!');
        });

        it('Empty message', () => {
            parser.parseLine('2001-01-01', '[01:23:45] *** Quits: Dinnerbone (dinnerbone@dinnerbone.com) ()');
            expect(on.quit).to.have.been.calledOnce.calledWithExactly(moment('2001-01-01T01:23:45Z'), 'Dinnerbone', '');
        });
    });
    ...
    describe('Parsing a topic change', () => {
        it('Ordinary topic', () => {
            ...
            expect(on.topic).to.have.been.calledOnce.calledWithExactly(moment('2001-01-01T01:23:45Z'), 'Dinnerbone', 'It\'s a channel about nothing!');
        });

        it('Empty message', () => {
            parser.parseLine('2001-01-01', '[01:23:45] *** Dinnerbone changes topic to \'\'');
            expect(on.topic).to.have.been.calledOnce.calledWithExactly(moment('2001-01-01T01:23:45Z'), 'Dinnerbone', '');
        });
    });
});