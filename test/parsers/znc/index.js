...
describe('Parsing a line', () => {
    ...
    describe('Parsing a message', () => {
        it('Ordinary message', () => {
            ...
            expect(onMessage).to.have.been.calledOnce.calledWithExactly('2001-01-01 01:23:45', 'Dinnerbone', 'Hello world! :)');
        });

        it('Empty message', () => {
            const onMessage = sinon.spy(counter, 'onMessage');
            parser.parseLine('2001-01-01', '[01:23:45] <Dinnerbone>  ');
            expect(onMessage).to.have.been.calledOnce.calledWithExactly('2001-01-01 01:23:45', 'Dinnerbone', ' ');
        });
    });
    ...
    describe('Parsing an action', () => {
        it('Ordinary action', () => {
            ...
            expect(onAction).to.have.been.calledOnce.calledWithExactly('2001-01-01 01:23:45', 'Dinnerbone', 'does an action');
        });

        it('Empty action', () => {
            const onAction = sinon.spy(counter, 'onAction');
            parser.parseLine('2001-01-01', '[01:23:45] * Dinnerbone ');
            expect(onAction).to.have.been.calledOnce.calledWithExactly('2001-01-01 01:23:45', 'Dinnerbone', '');
        });
    });
    ...
    it('Parsing a join', () => {
        ...
        expect(onJoin).to.have.been.calledOnce.calledWithExactly('2001-01-01 01:23:45', 'Dinnerbone');
    });
    ...
    describe('Parsing a kick', () => {
        it('Ordinary kick', () => {
            ...
            expect(onKick).to.have.been.calledOnce.calledWithExactly('2001-01-01 01:23:45', 'Dinnerbone', 'Troll', 'You suck!');
        });

        it('Empty message', () => {
            const onKick = sinon.spy(counter, 'onKick');
            parser.parseLine('2001-01-01', '[01:23:45] *** Troll was kicked by Dinnerbone ( )');
            expect(onKick).to.have.been.calledOnce.calledWithExactly('2001-01-01 01:23:45', 'Dinnerbone', 'Troll', ' ');
        });
    });
    ...
    describe('Parsing a mode change', () => {
        it('Adding a single mode', () => {
            ...
            expect(onMode).to.have.been.calledOnce.calledWithExactly('2001-01-01 01:23:45', 'Dinnerbone', '+m');
        });
        ...
        it('Adding a single mode with parameter', () => {
            ...
            expect(onMode).to.have.been.calledOnce.calledWithExactly('2001-01-01 01:23:45', 'Dinnerbone', '+v voice');
        });
        ...
        it('Adding and removing multiple modes with parameters', () => {
            ...
            expect(onMode).to.have.been.calledOnce.calledWithExactly('2001-01-01 01:23:45', 'Dinnerbone', '+vm-oS+k voice op key');
        });
    });
    ...
    it('Parsing a name change', () => {
        ...
        expect(onNick).to.have.been.calledOnce.calledWithExactly('2001-01-01 01:23:45', 'Dinnerbone', 'Djinnibone');
    });
    ...
    describe('Parsing a notice', () => {
        it('Ordinary notice', () => {
            ...
            expect(onNotice).to.have.been.calledOnce.calledWithExactly('2001-01-01 01:23:45', 'Dinnerbone', 'Hey, listen!');
        });

        it('Empty notice', () => {
            const onNotice = sinon.spy(counter, 'onNotice');
            parser.parseLine('2001-01-01', '[01:23:45] -Dinnerbone-  ');
            expect(onNotice).to.have.been.calledOnce.calledWithExactly('2001-01-01 01:23:45', 'Dinnerbone', ' ');
        });
    });
    ...
    describe('Parsing a part', () => {
        it('Ordinary part', () => {
            ...
            expect(onPart).to.have.been.calledOnce.calledWithExactly('2001-01-01 01:23:45', 'Dinnerbone', 'Goodbye, cruel channel!');
        });

        it('Empty message', () => {
            const onPart = sinon.spy(counter, 'onPart');
            parser.parseLine('2001-01-01', '[01:23:45] *** Parts: Dinnerbone (dinnerbone@dinnerbone.com) ()');
            expect(onPart).to.have.been.calledOnce.calledWithExactly('2001-01-01 01:23:45', 'Dinnerbone', '');
        });
    });
    ...
    describe('Parsing a quit', () => {
        it('Ordinary part', () => {
            ...
            expect(onQuit).to.have.been.calledOnce.calledWithExactly('2001-01-01 01:23:45', 'Dinnerbone', 'Goodbye, cruel network!');
        });

        it('Empty message', () => {
            const onQuit = sinon.spy(counter, 'onQuit');
            parser.parseLine('2001-01-01', '[01:23:45] *** Quits: Dinnerbone (dinnerbone@dinnerbone.com) ()');
            expect(onQuit).to.have.been.calledOnce.calledWithExactly('2001-01-01 01:23:45', 'Dinnerbone', '');
        });
    });
    ...
    describe('Parsing a topic change', () => {
        it('Ordinary topic', () => {
            ...
            expect(onTopic).to.have.been.calledOnce.calledWithExactly('2001-01-01 01:23:45', 'Dinnerbone', 'It\'s a channel about nothing!');
        });

        it('Empty message', () => {
            const onTopic = sinon.spy(counter, 'onTopic');
            parser.parseLine('2001-01-01', '[01:23:45] *** Dinnerbone changes topic to \'\'');
            expect(onTopic).to.have.been.calledOnce.calledWithExactly('2001-01-01 01:23:45', 'Dinnerbone', '');
        });
    });
});